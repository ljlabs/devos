 ...
 *   - python.exe main.py * (any args to this script)
 *   - python.exe * (any python script)
 *   - Any bash command * (simple executable prefix)
 */
function derivePatternVariants(command: string): Array<{ label: string; pattern: string }> {
  if (!command) return [];
