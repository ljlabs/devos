...
export class TerminalManager {
  ...
  /**
   * Detect the appropriate interactive shell for the current platform.
   *
   * DevOS intentionally does not inject prompt hooks or terminal control
   * sequences. Shell output is forwarded to xterm unchanged.
   */
